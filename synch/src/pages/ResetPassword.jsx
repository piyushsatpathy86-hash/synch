    ...
    <div className="relative min-h-[calc(100vh-4rem)] flex items-center justify-center px-4 overflow-hidden bg-gradient-to-b from-white to-gray-50">
      ...
      <div className="relative w-full max-w-sm bg-white border border-gray-100 rounded-3xl shadow-xl shadow-gray-200/60 p-8">
        <div className="mb-6 text-center">
          <p className="text-[11px] font-bold uppercase tracking-[0.1em] text-orange mb-2">Almost there</p>
          <h1 className="text-2xl font-extrabold tracking-tight text-navy">Set a new password</h1>
          <p className="text-gray-mid text-sm mt-1">Choose a new password for your account</p>
        </div>

        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <div>
            <label className="text-xs font-semibold text-gray-mid mb-1 block">New password</label>
            <input
              type="password"
          ...
          <div>
            <label className="text-xs font-semibold text-gray-mid mb-1 block">Confirm password</label>
            <input
              type="password"
