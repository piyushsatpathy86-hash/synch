...
export default function ForgotPassword() {
  ...
  return (
    <div className="relative min-h-[calc(100vh-4rem)] flex items-center justify-center px-4 overflow-hidden bg-gradient-to-b from-white to-gray-50">
      ...
      <div className="pointer-events-none absolute -bottom-24 -left-24 w-72 h-72 rounded-full bg-teal/10 blur-3xl" />
      ...
      <div className="relative w-full max-w-sm bg-white border border-gray-100 rounded-3xl shadow-xl shadow-gray-200/60 p-8">
        <div className="mb-6 text-center">
          <p className="text-[11px] font-bold uppercase tracking-[0.1em] text-orange mb-2">Account recovery</p>
          <h1 className="text-2xl font-extrabold tracking-tight text-navy">Reset your password</h1>
