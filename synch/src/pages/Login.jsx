...
export default function Login() {
  ...
  return (
    <div className="relative min-h-[calc(100vh-4rem)] flex items-center justify-center px-4 overflow-hidden bg-gradient-to-b from-white to-gray-50">
      <div className="pointer-events-none absolute -top-24 -right-24 w-72 h-72 rounded-full bg-orange/10 blur-3xl" />
      <div className="pointer-events-none absolute -bottom-24 -left-24 w-72 h-72 rounded-full bg-purple/10 blur-3xl" />
      ...
      <div className="relative w-full max-w-sm bg-white border border-gray-100 rounded-3xl shadow-xl shadow-gray-200/60 p-8">
        <div className="mb-6 text-center">
          <p className="text-[11px] font-bold uppercase tracking-[0.1em] text-orange mb-2">Welcome back</p>
          <h1 className="text-2xl font-extrabold tracking-tight text-navy">Log in to Synch</h1>
          <p className="text-gray-mid text-sm mt-1">Pick up where you left off</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-1">
              <label className="text-xs font-semibold text-gray-mid block">Password</label>
